...
frequency_ranked_letters = ['E', 'T', 'A', 'O', 'H', 'N', 'R', 'I', 'S', 'D',
                            'L', 'W', 'U', 'G', 'F', 'B', 'M', 'Y', 'C', 'P', 'K', 'V', 'Q', 'J', 'X', 'Z']
...
decoder = {frequency_tuples[i][0]: letter for (
    i, letter) in enumerate(frequency_ranked_letters)}
# print(decoder)
decoded_text = ''
for char in text:
