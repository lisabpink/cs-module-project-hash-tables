...
# A hashtable really only needs two operations: put and get:
# put(key, value): add a mapping from key to value to the table.
        # If there’s already a mapping for the key, then replace it.
